...
import time 
ssss = '6264668799'
bot = telebot.TeleBot("7859459096:AAHGtm64ABoBdKzjQatHGkUFIQl4uAcGxYk")
p3 = types.InlineKeyboardMarkup()
p5 = types.InlineKeyboardButton(text = "𝕡𝕣𝕠𝕘𝕣𝕒𝕞𝕞𝕖𝕣 𝕞𝕦𝕙𝕒𝕞𝕞𝕒𝕕 🇫🇰",url="t.me/KOK0KK")
...
في قائمة المطاية اصبح مطي جديد*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == ".":
		f2 = message.from_user.first_name
		p3 = types.InlineKeyboardMarkup()
		p5 = types.InlineKeyboardButton(text = "🇰🇼",url="t.me/KOK0KK")
		p3.add(p5)
...
*لا يمكنك ارسال الروابط*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
	...
	if m == "المطور" or m == "مطور" or m == "المبرمج":
		p3 = types.InlineKeyboardMarkup()
		e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/KOK0KK")
		p3.add(e4)
		h = """[مطور السورس .](t.me/KOK0KK)"""
...
نوع الحيوان : {}*""".format(f2,t2,r222,d222),disable_web_page_preview=True,parse_mode="markdown")
	if message.text == "السورس" or message.text == "سورس":
	    url = ["https://telegra.ph/file/c5952790fa8235f499749.jpg","https://telegra.ph/file/c5952790fa8235f499749.jpg","https://telegra.ph/file/9b1fac153873b32ba6a80.jpg","https://telegra.ph/file/9b1fac153873b32ba6a80.jpg"]
	    p3 = types.InlineKeyboardMarkup()
	    e3 = types.InlineKeyboardButton(text = "قناة السورس .",url="t.me/Your_uncle_Muhammad")
	    e4 = types.InlineKeyboardButton(text = "المطور .",url="t.me/KOK0KK")
	    p3.add(e3,e4)
	    r = random.choice(url)
	    h = """اهلا بك عزيزي 
[قناة السورس .](t.me/Your_uncle_Muhammad)
[مطور السورس .](t.me/KOK0KK)"""
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
	p3 = types.InlineKeyboardMarkup()
	p5 = types.InlineKeyboardButton( "𝕡𝕣𝕠𝕘𝕣𝕒𝕞𝕞𝕖𝕣 𝕞𝕦𝕙𝕒𝕞𝕞𝕒𝕕  🇰🇼",url="t.me/KOK0KK")
	p3.add(p5)
...
CH - @PJPPPPPP : @BBANND*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	...
	if message.text == "لاعبين" or message.text == "" or message.text == "افتار لاعب" or message.text == "افتار لاعبين":
		photo_str =  random.randint(74,154)
		avtar_ball = "https://t.me/DjAseel111/" + str(photo_str)
...
- @planet_646333bot*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	if message.text == "غنيلي" or message.text == "غ":
		song_str = random.randint(74,154)
		song_voice = "https://t.me/dj_spy/" + str(song_str)
...
- @planet_646333bot*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	if message.text == "هلو":
		...
		bot.reply_to(message,"اسمي ↫ 𝙿𝙻𝙰𝙽𝙴𝚃 افتهم عادد")
